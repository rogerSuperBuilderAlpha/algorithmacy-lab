...
## 0b. Style pass, 2026-08-02

Dedicated writing-style review in `reviews/2026-08-02/11_style.md`, applied to `chapter.md`. Bar: direct and
clear; gloss jargon; no throat-clearing or meta commentary. Cleared: §1 meta cluster, §5.1 jargon-first
opening (bypass now leads), §5.2 self-narration frames, §8 "For X, the argument…" triad, §9 antithesis pile,
Ananny refrain to one full statement plus callbacks. Post-pass: `the argument` = 0; antithesis ~1.9/1k;
body ~11,600 words. See the review's post-pass table.
