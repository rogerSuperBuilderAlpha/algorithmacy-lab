...
Writing arms that do not belong in the `org_frontier` Python package. Computational results stay
under [`../org_frontier/`](../org_frontier/). Live dates are in [`CALENDAR.md`](CALENDAR.md).
This week's work is listed first in [`../NOW.md`](../NOW.md).

| Path | Piece | Due |
| --- | --- | --- |
| [`coordinative_sovereignty/`](coordinative_sovereignty/) | IGI chapter: Algorithmacy and Sovereignty | 2026-08-30 |
...
| [`dial_response_algorithmacy/`](dial_response_algorithmacy/) | IJHCS full article re-coding Belousov et al.'s (2027) DIAL corpus for algorithmacy — reach × act framework, IIT criterion, engagement layer (full draft); also the PHD1750-3 independent-study deliverable; `corpus/` holds the sci-fi interfaces essay and per-work catalog | no deadline |
