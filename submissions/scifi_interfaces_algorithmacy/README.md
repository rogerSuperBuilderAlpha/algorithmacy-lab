...
**Essay title.** Algorithmacy and the Triadic Interface: Decoding the Future of Human-Computer Interaction in Speculative Fiction.
...
This arm borrows the lab's construct (algorithmacy as triadic competency). It does not re-run Φ.
