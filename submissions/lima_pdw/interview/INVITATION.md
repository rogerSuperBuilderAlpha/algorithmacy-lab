# Invitation to participate — the message to send

**Before this goes out, fill the two bracketed slots.** One is the IRB determination line; see
"Before sending" at the foot of this file. Do not send it with the placeholder in place.
