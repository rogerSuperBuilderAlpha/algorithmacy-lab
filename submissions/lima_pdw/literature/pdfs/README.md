# Acquired PDFs — local only

These files are gitignored. Do not commit them. They were dropped 2026-08-19
for the research plan in `../../manuscript/RESEARCH_PLAN.md`.

| file | paper |
|---|---|
| `sandberg2000.pdf` | Sandberg, *AMJ* 43(1). Scanned; OCR text at `/tmp` if regenerated. |
| `sutherland2020.pdf` | Sutherland, Jarrahi, Dunn & Nelson, *WES* 34(3) |
| `suddaby2010.pdf` | Suddaby, *AMR* 35(3) |
| `guzmanlewis2020.pdf` | Guzman & Lewis, *NMS* 22(1) |
| `zhou2025apjhr_workingpaper.pdf` | Zhou, Lei, Liu, Huang & Hou — **working paper**, not the journal version |
| `pratt2009.pdf` | Pratt, *AMJ* 52(5) |
| `pratt2020.pdf` | Pratt, Kaplan & Whittington, *ASQ* 65(1) |
| `pratt2022.pdf` | Pratt, Sonenshein & Feldman, *ORM* (bricolage) |
| `gioia2013.pdf` | Gioia, Corley & Hamilton, *ORM* 16(1) |
