...
- [The Hiring Gate: Whether an Applicant Tracking System Commits the Screen or Stores It for a Manager to Decide](org_frontier/qualitative/ats_hiring_gate/STUDY.md) — A candidate applies, an applicant tracking system (ATS) screens the application, and a hiring manager rules on who advances
