...
remains open. *Slacker* has one fixed order, the same for every viewer, and it knows nothing about whoever is
watching. I want to know how that order works, and what changes when the same selecting position becomes
a platform that can read its audience back.
...
Three questions help locate the difference, but the definitions carry it. Does the third act on a whole
field or on a selected path through it? Could the encounter have happened without this third? Does the
third know who the parties are and change what it does on that basis? Austin acts on the whole street,
is one route among many, and reads types at most. Uber chooses a pair and is the route to that match; its
strongest evidence for reading comes after and around the match, when the platform prices, rates, and can
remove. The camera is the mixed case that matters here: it chooses the next person the viewer meets but
knows nothing about that person or the viewer. It is an **attentional selector**. Uber is a
**transactional selector**.

The questions diagnose thirds that operate where people are already reachable. They do not classify a
third that destroys reachability. Simmel's *divide et impera*, the strategy of dividing in order to rule,
acts on everyone and knows nothing about particulars while forbidding possible associations.[^19] The
...
intermediaries and leave the non-human one unexamined.[^23][^24]

## 3. Austin as setting

A man leaves a coffee shop and a stranger falls into step beside him, talking about the moon landings
and pulling just enough answers from him to keep the encounter alive. A woman works the sidewalk
selling what she swears is Madonna's pap smear, and gets a hearing. These encounters happen in foci:
...
The material base was ordinary. Housing stock rose 48.0 percent between 1980 and 1990 while
...
Empty rooms made unstructured time easier to sustain, and unstructured time is what this film is about.
Urban economists call one effect of a large market matching: more possible jobs, bands, and rooms improve
the odds of a fit, though matching cannot be separated cleanly from sharing and learning in the data.[^31]
Mion and Naticchioni also find that larger markets do not simply pair like with like more often.[^32]
...
a downtown sidewalk, and it has always been available against somebody else. Reuben A. Buford May finds the same
...
That decision is constrained. Usually the camera can only leave with someone the city has already put
within reach of the lens. When a cut fakes that reach, Austin supplies the bodies and the film
manufactures the walk between them.
...
perceiver, but not any sender, of a message." He grants the selecting and refuses the selector.
Narration, on his description, sometimes suppresses information, often restricts what we know, generates
curiosity, and creates a tone; he lists those functions to argue that no narrator needs to be added
behind them.[^38] Seymour Chatman answered him with a narrator already stripped of personality, "the
composite of a large and complex variety of communicating devices."[^39]

Mario Slugan reports "little debate on this matter among film scholars in general," among whom the
narrator view predominates and Bordwell is the most prominent exception.[^40] I take the philosophers'
...
string because the network he is looking for is not there. What is there is a sequence. The film runs
two shapes at once. Among the characters it is a bare chain, each one tied only to whoever shares their sidewalk for
...
other; the camera coordinates *me*, serially, with one of them after another. Attentional selectors
compose what a viewer meets next. Transactional selectors assemble parties who have to live with the
match. The two jobs share selection and little else.
...
driver gets which ride, and the two cannot settle the match between themselves. Lee, Kusbit, Metsky,
and Dabbish named algorithmic management in their Uber and Lyft study; Rosenblat and Stark then made
information asymmetry the centre of the case.[^47]
...
their lives is expanding almost daily."[^56] His bet was hopeful, but his mechanism was shock and
reception in distraction. The training was to produce a public equal to the machinery through habits
the machinery itself cultivated. Miriam Hansen keeps both halves in view, calling cinema "the single most
...
Hollywood, and *negotiated* is the last of five participles in a list that starts with reflected and
...
twenty read hunger; on the child sequence, nobody showed the effect at all.[^58] Eleven of twenty
...
Cinema made serial selection readable. It did not teach anyone to inspect or contest a platform.
Five searches found no study relating film-editing fluency to comprehension of a recommender or dispatch
queue, and two reviews of algorithmic literacy contain no film variable.[^63] General media literacy and
algorithm awareness are only inconsistently related in the same students.[^64] Smith, Essex, and Bedford
leave the benefit domain-bound: it "may be specific to the domain of movie narrative comprehension and
not transfer to more general applications." The trial that would connect film fluency to platform
reading has not been run.[^65]
...
convergence and stayed coordinated anyway. A slack and legible city put them within reach; a camera
showed them one at a time in a fixed order. The resemblance to a platform begins with that selection.
Platform power begins when the selector can read and govern the people whose activity it orders.
...
[^47a]: David Stark and Ivana Pais, "Algorithmic Management in the Platform Economy," *Sociologica* 14, no. 3 (2020): 47–72; Katherine C. Kellogg, Melissa A. Valentine, and Angèle Christin, "Algorithms at Work: The New Contested Terrain of Control," *Academy of Management Annals* 14, no. 1 (2020): 366–410. Kellogg, Valentine, and Christin's six are restricting, recommending, recording, rating, replacing, and rewarding.
...
[^54]: Lindsey D. Cameron, "The Making of the 'Good Bad' Job," *Administrative Science Quarterly* 69, no. 2 (2024): 458–514.
...
[^62]: Lester C. Loschky, Adam M. Larson, Joseph P. Magliano, and Tim J. Smith, "What Would *Jaws* Do? The Tyranny of Film and the Relationship between Gaze and Higher-Level Narrative Film Comprehension," *PLOS ONE* 10, no. 11 (2015): e0142474.
[^63]: Emilija Gagrčin, Teresa K. Naab, and Maria F. Grub, "Algorithmic Media Use and Algorithm Literacy: An Integrative Literature Review," *New Media & Society* 28, no. 1 (2026): 423–447, DOI 10.1177/14614448241291137 — a systematic review of 169 studies; Anne Oeldorf-Hirsch and German Neubaum, "What Do We Know About Algorithmic Literacy? The Status Quo and a Research Agenda for a Growing Field," *New Media & Society* 27, no. 2 (2025): 681–701, DOI 10.1177/14614448231182662, at 696: "much remains unknown, such as what predicts algorithmic literacy."
[^64]: Jessica E. Brodsky, Dvora Zomberg, Kasey L. Powers, and Patricia J. Brooks, "Assessing and Fostering College Students' Algorithm Awareness Across Online Contexts," *Journal of Media Literacy Education* 12, no. 3 (2020): 43–57, DOI 10.23860/JMLE-2020-12-3-5. Two studies of US college students, N = 222 and N = 244: "Across studies, students demonstrated high media literacy knowledge, yet knowledge was inconsistently related to algorithm awareness."
...
Brodsky, Jessica E., Dvora Zomberg, Kasey L. Powers, and Patricia J. Brooks. "Assessing and Fostering College Students' Algorithm Awareness Across Online Contexts." *Journal of Media Literacy Education* 12, no. 3 (2020): 43–57.

Burt, Ronald S. *Structural Holes: The Social Structure of Competition*. Cambridge, MA: Harvard University Press, 1992.

Cameron, Lindsey D. "The Making of the 'Good Bad' Job: How Algorithmic Management Manufactures Consent Through Constant and Confined Choices." *Administrative Science Quarterly* 69, no. 2 (2024): 458–514.
...
Gagrčin, Emilija, Teresa K. Naab, and Maria F. Grub. "Algorithmic Media Use and Algorithm Literacy: An Integrative Literature Review." *New Media & Society* 28, no. 1 (2026): 423–447.
...
Lee, Min Kyung, Daniel Kusbit, Evan Metsky, and Laura Dabbish. "Working with Machines: The Impact of Algorithmic and Data-Driven Management on Human Workers." In *Proceedings of the 33rd Annual ACM Conference on Human Factors in Computing Systems*, 1603–1612. New York: ACM, 2015.
...
Smith, Tim J., and John M. Henderson. "Edit Blindness: The Relationship between Attention and Global Change Blindness in Dynamic Scenes." *Journal of Eye Movement Research* 2, no. 2 (2008): article 6, 1–17.
