...
affordances. Sections 3 and 4 carry the argument. Section 5 introduces algorithmacy and sovereignty
**once each** and does not restate them later; if a construct needs a second explanation to survive,
it is not earning its keep and should become a citation to
[`../../coordinative_sovereignty/`](../../coordinative_sovereignty/) instead.
...
- **Diagnostic table: how a reader classifies a real touchpoint.** Columns for what the algorithm
  ...
  the section that makes the framework usable by a reviewer, and it is the strongest defence
