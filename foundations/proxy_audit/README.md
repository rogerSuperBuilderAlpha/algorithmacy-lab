...
python -m foundations.proxy_audit.run 15 1      # per_cell=15, seed=1  -> results/audit.csv
python -m foundations.proxy_audit.analyze        # -> correlation table, summary.csv, plot
```
