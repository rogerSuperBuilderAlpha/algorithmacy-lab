...
```bash
python -m foundations.structure_suite.run 1       # -> results/suite.csv
python -m foundations.structure_suite.analyze      # -> summary.csv, suite_corr.png, phi_vs_structure.png
```
